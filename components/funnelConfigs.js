...
export const funnelConfigs = {
  ...
  steps: [
    {
      ...commonZipStep(),
      title: "Let's Find the Best Solar Options for Your Home!",
      description: "Not all areas qualify — check your zip code",
      pageHeading: "",
      pageSubtitle: "",
  ...
  noCardBorder: true,
  thankYouHeading: "Your request is in!",
  thankYouSubtitle: "A turf specialist will be calling you shortly. While you wait — can we help with anything else at your home?",
  ...
  steps: [
    ...
    {
      ...commonAddressStep("home security system"),
  ...
  thankYouSubtitle: "A local HVAC specialist will be calling you shortly. While you wait — can we help with anything else at your home?",
  crossSellOptions: [
    {
      label: "🏠 Roofing",
      tagline: "Get your roof inspected for FREE",
  ...
  steps: [
    {
      ...commonZipStep(),
      title: "Let's Find the Best Flooring Options for Your Home!",
      description: "Check availability in your area",
      nextLabel: "Check My Area →",
      trustBadges: true,
      prefillSkip: true,
    ...
    {
      key: "flooringType",
      title: "What type of flooring are you interested in?",
      type: "options",
      layout: "stack",
      options: [
        { label: "🪵 Hardwood", value: "Hardwood" },
    ...
    {
      key: "flooringRooms",
      title: "Which rooms need new flooring?",
      type: "options",
      layout: "stack",
      options: [
        { label: "Living Room", value: "Living Room" },
